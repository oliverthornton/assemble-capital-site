...
# --- social ----------------------------------------------------------------
# LinkedIn, Instagram, Facebook and TikTok are live (confirmed w/ Oliver,
# Aug 2026). No Twitter/X or YouTube profiles exist — leave those out rather
# than linking a placeholder.
#
# URLs are stored in the canonical form each platform redirects to (trailing
# slash on LinkedIn/Instagram), so footer links and Organization sameAs match
# the profile exactly and skip a redirect hop. Share/tracking parameters
# (Facebook's mibextid, etc.) are deliberately stripped.
LINKEDIN = "https://www.linkedin.com/company/assemble-capital-real-estate/"
INSTAGRAM = "https://www.instagram.com/assemble.capital/"
FACEBOOK = "https://www.facebook.com/profile.php?id=61565401305284"
TIKTOK = "https://www.tiktok.com/@assemble.capital"
...
def social(base):
    ...
    if TIKTOK:
        out.append(btn("tiktok", TIKTOK, "TikTok"))
